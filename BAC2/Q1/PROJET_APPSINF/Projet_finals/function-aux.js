...
function ajouter(){
    return ["Ajouter avec succès","Veillez selectionner au moins un livre"]
}
...
function error(){
    ...
    "Les mots de passe sont differents.","Un des Livre n'est plus disponible","verifiez la date","Vous n'avez selectionné aucun livre"]
}
