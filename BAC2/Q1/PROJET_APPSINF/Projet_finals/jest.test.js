...
describe("",()=>{
    ...
    test("page d'identification",async()=>{
        ...
        await driver.findElement(By.name("utilisateur")).sendKeys("Lamarana");
        await driver.findElement(By.name("mot_de_passe")).sendKeys("user2");
    ...
    test("profile",async()=>{
        await driver.get("https://localhost:10");
        await driver.findElement(By.id("connect")).click();
        await driver.findElement(By.name("utilisateur")).sendKeys("diallo");
        await driver.findElement(By.name("mot_de_passe")).sendKeys("user2",Key.RETURN);
    ...
    test("graphique", async()=>{
        ...
        await driver.findElement(By.name("dropdown")).sendKeys(Key.RETURN);
        await driver.findElement(By.name("profile_bout")).sendKeys(Key.RETURN);
        await driver.findElement(By.name("graph1")).sendKeys(Key.RETURN);
        await driver.sleep(500);
        await driver.findElement(By.name("graph2")).click();
        await driver.sleep(500);
    })
});
